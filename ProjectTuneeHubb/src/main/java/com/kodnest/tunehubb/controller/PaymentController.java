...
public class PaymentController {
	...
	public String createOrder(HttpSession session) {
		...
		Order order=null;
		try {
			RazorpayClient razorpay=new RazorpayClient("rzp_test_qa2kM7ynRtOyAL", "9ET9ARNLh5fwL8gYNvcF4EPW");
...
//			userService.updateUser(user);
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
		...
		try {
			...
			RazorpayClient razorpayClient = new RazorpayClient("rzp_test_qa2kM7ynRtOyAL", 
					"9ET9ARNLh5fwL8gYNvcF4EPW");
